...
object_categories = ['angel','Child_Jesus','crucifixion_of_Jesus','Mary','nudity', 'ruins','Saint_Sebastien']
...
class main_IconArt_v1Classification(data.Dataset):
    def __init__(self, root, set, transform=None, target_transform=None):
        ...
        print('[dataset] IconArt_v1 classification set=%s number of classes=%d  number of images=%d' % (
