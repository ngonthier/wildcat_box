...
object_categories = ['aeroplane','bird','boat','chair','cow','diningtable','dog','horse','sheep','train']
...
class ArtUKlassification(data.Dataset):
    def __init__(self, root, set, transform=None, target_transform=None):
        ...
        file_csv = os.path.join(path_csv, 'Paintings_Classification_' + set + '.csv')
        ...
        print('[dataset] ArtUK classification set=%s number of classes=%d  number of images=%d' % (
