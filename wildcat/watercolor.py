...
object_categories = ["bicycle", "bird","car", "cat", "dog", "person"]
...
class watercolorClassification(data.Dataset):
    def __init__(self, root, set, transform=None, target_transform=None):
        ...
        print('[dataset] Watercolor classification set=%s number of classes=%d  number of images=%d' % (
