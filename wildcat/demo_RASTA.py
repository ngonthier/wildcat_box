...
from wildcat.engine import MulticlassTop5Engine
from wildcat.models import resnet101_wildcat
from wildcat.rasta import rastaClassification
...
def main_rasta():
    ...
    # define dataset
    train_dataset = rastaClassification(args.data, 'trainval')
    val_dataset = rastaClassification(args.data, 'test')
    num_classes = 25
    ...
    state['save_model_path'] = '../expes/models/rasta/'

    engine = MulticlassTop5Engine(state)
