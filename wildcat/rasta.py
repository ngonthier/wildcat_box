...
object_categories = ["Abstract_Art","Abstract_Expressionism","Art_Informel",\
"Art_Nouveau_(Modern)","Baroque","Color_Field_Painting","Cubism","Early_Renaissance",\
"Expressionism","High_Renaissance","Impressionism","Magic_Realism","Mannerism_(Late_Renaissance)"\
,"Minimalism","Naïve_Art_(Primitivism)","Neoclassicism","Northern_Renaissance","Pop_Art",\
...
class rastaClassification(data.Dataset):
    def __init__(self, root, set, transform=None, target_transform=None):
        ...
        path_csv = '/media/HDD/data/RASTA_LAMSADE/wikipaintings_full/'
        # define filename of csv file name_file_test = path_data + 'Paintings_Classification_test.csv'
        file_csv = os.path.join(path_csv, 'wikipaintings_' + set + '.csv')
        ...
        print('[dataset] RASTA classification set=%s number of classes=%d  number of images=%d' % (
