...
from wildcat.WikiTenLabels import main_WikiTenLabelsClassification
...
def main_WikiTenLabels():
    ...
    # define dataset
    train_dataset = main_WikiTenLabelsClassification(args.data, 'trainval')
    val_dataset = main_WikiTenLabelsClassification(args.data, 'test')
    num_classes = 10
    ...
    state['save_model_path'] = '../expes/models/WikiTenLabels/'
